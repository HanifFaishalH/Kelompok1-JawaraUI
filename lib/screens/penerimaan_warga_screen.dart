...
class _PenerimaanWargaScreenState extends State<PenerimaanWargaScreen> {
  ...
  final List<PermintaanAkun> _permintaanList = [
    PermintaanAkun(
      ...
      jenisKelamin: 'L', 
      fotoIdentitasUrl: 'https://placehold.co/100x70/7F00FF/D8BFD8?text=Foto+Identitas+1' // Placeholder
    ),
    PermintaanAkun(
      no: 2, 
      nama: 'Anti Micin', 
      ...
      jenisKelamin: 'L', 
      fotoIdentitasUrl: 'https://placehold.co/100x70/4C008D/D8BFD8?text=Foto+Identitas+2' // Placeholder
    ),
    PermintaanAkun(
      no: 3, 
      nama: 'Ijat', 
      ...
      jenisKelamin: 'P', 
      fotoIdentitasUrl: 'https://placehold.co/100x70/7F00FF/D8BFD8?text=Foto+Identitas+3' // Placeholder
    ),
  ];

  String? _filterNama;
  String? _filterJenisKelamin;
  String? _filterStatus; // Ditambahkan untuk filter, meskipun tidak ada di kolom tabel
          ...
          builder: (context, setStateModal) {
            return AlertDialog(
              ...
              title: Row(
                ...
                children: [
                  Text('Filter Penerimaan Warga', style: Theme.of(context).textTheme.titleLarge),
                  IconButton(
              ...
              content: Column(
                ...
                children: [
                  // Nama Filter
                  Text('Nama', style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontWeight: FontWeight.bold)),
                  ...
                  Text('Jenis Kelamin', style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: ['Pending', 'Diterima', 'Ditolak'].map((String status) {
                      return DropdownMenuItem<String>(
                        value: status,
                        child: Text(status),
                      );
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: AppTheme.brightPurple,
  ...
  List<PermintaanAkun> get _filteredPermintaanList {
    if (_filterNama == null && _filterJenisKelamin == null && _filterStatus == null) {
      ...
      body: Container(
        decoration: const BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [AppTheme.offWhite, AppTheme.lightPurple],
        ...
        child: CustomScrollView(
          slivers: [
            SliverAppBar(
              title: Text('Penerimaan Warga', style: theme.textTheme.displayLarge!.copyWith(color: AppTheme.offWhite)),
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            elevation: 5,
                            minimumSize: const Size(60, 50), // Buat lebih kotak dan terlihat seperti tombol filter di screenshot
                          ),
                          child: const Icon(Icons.filter_list, color: AppTheme.offWhite),
                        ),
                      ),
                      ...
                      SingleChildScrollView(
                        ...
                        child: DataTable(
                          columnSpacing: 24,
                          horizontalMargin: 8,
                          headingRowColor: MaterialStateProperty.all(AppTheme.lightPurple),
                          headingTextStyle: theme.textTheme.bodyLarge!.copyWith(fontWeight: FontWeight.bold, color: AppTheme.darkPurple),
                          columns: const [
                                ...
                                DataCell(
                                  ...
                                  InkWell(
                                    onTap: () {
                                      ...
                                      print('Lihat Foto Identitas ${permintaan.nama}');
                                    },
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        ...
                                        errorBuilder: (context, error, stackTrace) {
                                          return Container(
                                            ...
                                            child: const Center(child: Icon(Icons.broken_image, size: 20, color: AppTheme.darkPurple)),
                                          );
                                        },
                                      ),
                                    ),
                      ...
                      Row(
                        ...
                        children: [
                          IconButton(
                            icon: const Icon(Icons.arrow_back_ios, size: 16, color: AppTheme.lightPurple),
                          ...
                          Container(
                            ...
                            child: const Text('1', style: TextStyle(color: AppTheme.offWhite, fontWeight: FontWeight.bold)),
                          ),
                          IconButton(
                            icon: const Icon(Icons.arrow_forward_ios, size: 16, color: AppTheme.lightPurple),
