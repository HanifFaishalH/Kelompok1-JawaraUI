...
class _DashboardScreenState extends State<DashboardScreen> {
              ...
              content: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: ['Diterima', 'Pending', 'Ditolak'].map((String status) {
  ...
  List<PesanWarga> get _filteredPesanList {
    ...
    return _pesanList.where((pesan) {
      final matchesJudul = _filterJudul == null || pesan.judul.toLowerCase().contains(_filterJudul!.toLowerCase());
      final matchesStatus = _filterStatus == null || pesan.status.toLowerCase() == _filterStatus!.toLowerCase();
    ...
    return Scaffold(
      body: Container(
        ...
        child: CustomScrollView(
          slivers: [
            SliverAppBar(
              title: Text('Dashboard Warga', style: theme.textTheme.displayLarge!.copyWith(color: AppTheme.offWhite)),
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          icon: const Icon(Icons.filter_list, color: AppTheme.offWhite),
                          label: const Text('Filter', style: TextStyle(color: AppTheme.offWhite)),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: AppTheme.brightPurple,
                              ...
                              cells: [
                                ...
                                DataCell(
                                  PopupMenuButton<String>(
                                    icon: const Icon(Icons.more_vert, color: AppTheme.darkPurple),
                                    onSelected: (String result) {
                                      if (result == 'Edit') {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (context) => const EditPesanScreen()),
                                        );
                                      } else if (result == 'Detail') {
                                        // TODO: Implement Detail Screen
                                        print('Lihat Detail Pesan ${pesan.judul}');
